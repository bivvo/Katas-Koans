...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Self NOTE: Ran a test in irb. The shovel operator append to the current string keeping the current
    # object_id. While the += operator creates a new instance of the string. 
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # Not really. It is a 0 based index. Most string when broken down to char are 0 based.
  end
