...
class AboutObjects < EdgeCase::Koan
  ...
  def test_objects_can_be_inspected #SELF NOTE: inspect give a string representation of the object.includes the object id in some instance uses underlying to_s
  ...
  def test_small_integers_have_fixed_ids
    ...
    # SELF NOTE: Small integers are all odd values.
  end
